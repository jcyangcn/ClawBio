...
<p align="center">
  ...
  <a href="https://clawhub.ai"><img src="https://img.shields.io/badge/ClawHub-95_skills-orange" alt="ClawHub Skills"></a>
...
**95 skills (89 with runnable demo data) + 8,182 Galaxy tools + 4,280 tests + benchmark validation. Local-first by default. Reproducible. No guessing.**
...
ClawBio is the **first bioinformatics-native AI agent skill library**. Built on OpenClaw (180k+ GitHub stars), it provides 94 skills (88 with runnable demo data) for genomics analysis, pharmacogenomics, ancestry profiling, and more. Local-first, privacy-focused, and reproducible.
