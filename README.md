...
<p align="center">
  ...
  <a href="https://clawhub.ai"><img src="https://img.shields.io/badge/ClawHub-76_skills-orange" alt="ClawHub Skills"></a>
...
**76 skills (27 production-ready) + 8,000 Galaxy tools + 2,027 tests + benchmark validation. Local-first. No cloud. No guessing.**
...
A curated cross-section of ClawBio's 76 skills. The full machine-readable catalog (with status flags, trigger keywords, demo commands, and chaining partners) lives in [`skills/catalog.json`](skills/catalog.json); browse the directory at [`skills/`](skills/) to see every skill folder.
