...
_mod_path = Path(__file__).parent / "rare_high_impact_variants.py"
_spec = spec_from_file_location("rare_high_impact_variants", _mod_path)
_mod = module_from_spec(_spec)
_spec.loader.exec_module(_mod)


def run(input_path: str, output_dir: str = "/tmp/rare-high-impact-variants") -> dict:
