...
_mod_path = Path(__file__).parent / "gi_enhancer.py"
_spec = spec_from_file_location("gi_enhancer", _mod_path)
_mod = module_from_spec(_spec)
_spec.loader.exec_module(_mod)


def run(input_path: str, output_dir: str = "/tmp/gi-enhancer") -> dict:
